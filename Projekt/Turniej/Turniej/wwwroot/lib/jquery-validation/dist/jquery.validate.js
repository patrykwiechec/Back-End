...
$.extend( $.validator, {
	...
	messages: {
		...
		equalTo: "Wprowadź tą samą wartość.",
		maxlength: $.validator.format( "Wprowadź mniej niż {0} znaków." ),
		minlength: $.validator.format( "Wprowadź więcej niż {0} znaków." ),
		rangelength: $.validator.format( "Wprowadź wartość o długości między {0}, a {1} znaków." ),
		...
		step: $.validator.format( "Wprowadź wielkrotność {0}." )
	},
